...
def add_victim_demo(complaints_t1, by_officer_df):
    ...
    # add victim demographics info
    by_officer_racial_breakdown, victim_race_cols = feat_engineer_helpers.add_victim_race(complaints_t1,
    ...
    by_officer_gender_breakdown, victim_gender_cols = feat_engineer_helpers.add_victim_race(complaints_t1,
                                                                                            complaints_victims,
                                                                                            "gender")
